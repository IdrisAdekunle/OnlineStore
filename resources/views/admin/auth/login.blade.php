...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="{{asset('backend/img/favicons/favicon.png')}}">
...
<div id="page-container" class="main-content-boxed">
    ...
    <main id="main-container">
        <!-- Page Content -->
        <div class="bg-image" style="background-image: url({{ URL::asset('/backend/img/photos/photo34@2x.jpg') }})">
            <div class="row mx-0 bg-black-op">
                ...
                <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                    <div class="content content-full">
                        ...
                        <form class="js-validation-signin px-30" action="{{route('admin.login.submit')}}" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <div class="form-material floating">
                                        <input type="email" class="form-control{{ $errors->has('email') ? 'Email not correct' : '' }}" id="login-username" name="email" value="{{ old('email') }}"  required>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-sm btn-hero btn-alt-primary" onclick="form.submit()">
...
<!-- Page JS Code -->
<script src="{{asset('backend/js/pages/op_auth_signin.js')}}assets"></script>
</body>
</html>
