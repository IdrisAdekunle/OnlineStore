        ...
        <div class="bg-black-op-75">
            <div class="content content-top content-full text-center">
                <div class="py-20">
                    ...
                    <h2 class="h4 font-w400 text-white-op mb-0">Edit category!</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-12">
                ...
                <div class="block">
                    ...
                    <div class="block-content">
                        <form action="{{route('blogcategory.update',$blogcategory->name )}}" method="POST" >
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="example-input1-group1" name="name" placeholder="Name" value="{{$blogcategory->name}}">
                                    </div>
                                </div>
                            </div>
